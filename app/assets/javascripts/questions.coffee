$ ->
  ...
  $('.answers').on 'click', 'a#create-new-answer', (e) ->
    e.preventDefault()
    $(this).hide()
    $('div#new-answer-form').show()
  ...
  $('body').on 'click', 'a.new-comment', (e) ->
    e.preventDefault()
    obj = $(this).data('comment-for')
    $('#' + obj + ' .new-comment-form-container').show()
